...
# Utiliza la sintaxis estándar de expresiones regulares.
...
# Busca un patrón especificado dentro de una cadena de texto y devuelve un objeto de coincidencia ("MatchObject") si encuentra una coincidencia.
...
# Por ejemplo, tienes la siguiente cadena de texto y deseas buscar la palabra "Python" en ella:
textoSearch = "Python es el mejor lenguaje de programación :)"
...
# Busca todas las coincidencias del patrón en la cadena y devuelve una lista de todas las coincidencias encontradas.
# Devuelve una lista vacía si no se encuentra ninguna coincidencia en la cadena.
# Tienes por ejemplo, una cadena de texto con múltiples direcciones de correo electrónico y deseas encontrar todas estas direcciones en la cadena:
...
# Acá utilizamos "re.findall()" con el patrón "r'\S+@\S+'" para buscar todas las direcciones de correo electrónico en la cadena "texto".
...
# Cada objeto de coincidencia proporcionado por el iterador contiene información sobre la posición y el contenido de la coincidencia, permitiendo realizar tareas específicas en cada coincidencia encontrada.
# Por ejemplo, tienes una cadena de texto con múltiples números de teléfono y deseas encontrar y procesar todas las ocurrencias de números de teléfono en la cadena:
...
# Busca todas las coincidencias del patrón en la cadena y las reemplaza con el texto o cadena especificada en "reemplazo".
...
print(f"Nuevo texto remplazado con 'sub': {nuevo_texto}")
...
# Los modificadores se pasan como argumento a las funciones del módulo "re" y permiten ajustar la forma en que se realiza la búsqueda.
# Son útiles para personalizar y ajustar la búsqueda de patrones de expresiones regulares según tus necesidades específicas.
...
# Hace que la búsqueda sea insensible a mayúsculas y minúsculas, significa que la expresión regular coincidirá con texto en cualquier combinación de mayúsculas y minúsculas.

# "flags=re.MULTILINE" o "re.M"
# Permite que la búsqueda se realice en varias líneas de texto.
...
# Este hace que el carácter punto (".") en la expresión regular coincida con cualquier carácter, incluyendo saltos de línea ("\n").
# Sin este modificador, el punto no coincidiría con saltos de línea por defecto.

# "flags=re.VERBOSE" o "re.X"
# Permite que escribas expresiones regulares de forma más legible al ignorar espacios en blanco y comentarios en la expresión.
...
# Para usar uno o varios de estos modificadores, simplemente los pasas como argumento al parámetro "flags" cuando llamas a una función del módulo "re".
...
# En este ejemplo, el uso de "flags=re.IGNORECASE" permite que la búsqueda sea insensible a mayúsculas y minúsculas,
# Por lo que encuentra la coincidencia "Python" en el texto a pesar de las diferencias de mayúsculas y minúsculas.
