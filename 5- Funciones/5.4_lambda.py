...
# Son muy útiles para operaciones simples y rápidas, como funciones de orden superior, filtrado y mapeo en listas.
...
# Aqui abajo otros ejemplos de funciónes creadas con lambda:
