...
# math
# Este módulo proporciona funciones matemáticas más avanzadas que las ya incluidas.
...
# random
# Este módulo sirve para generar números aleatorios y realizar selecciones aleatorias.
...
# datetime
# Permite realizar operaciones relacionadas con la manipulación de fechas, como crear, comparar, formatear y realizar cálculos con fechas y horas.

# "datetime.date()"
# Esta clase se utiliza para representar fechas sin información de hora. Puedes crear objetos "date" con año, mes y día.
date = datetime.date(2023,9,27)  # Por ejemplo, "datetime.date(2023, 9, 27)" representa el 27 de septiembre de 2023.

# "datetime.time()"
# Esta clase se utiliza para representar horas, minutos, segundos y microsegundos.
date_time = datetime.time(14,6,0)  # Por ejemplo, "datetime.time(14, 30, 0)" representa las 2:30 PM.

# "datetime.datetime()"
# Esta clase combina información de fecha y hora.
...
# "datetime.timedelta()"
# Esta clase se utiliza para representar una duración, es decir, una diferencia entre dos fechas o tiempos.
...
# time
# Este módulo proporciona funciones para trabajar con el tiempo y medir el tiempo transcurrido en tus programas.
...
# sys
# Este módulo proporciona funcionalidades que permiten interactuar con el intérprete de Python y el sistema operativo subyacente.
...
# sys.exit(código)  # Sale del programa. Si se proporciona un código, se considera como un código de salida. El valor por defecto es 0.
...
# csv:
# Este módulo proporciona funcionalidad para trabajar con archivos CSV (Comma-Separated Values), que son comunes para el intercambio de datos tabulares.



# requests
# Es un módulo popular para realizar solicitudes HTTP a través de la web, lo que lo hace ideal para interactuar con APIs y obtener datos de internet.
