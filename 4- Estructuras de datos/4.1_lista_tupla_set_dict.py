...
# Las listas se pueden modificar despues de haberlas creado.
# Almacena datos duplicados.
# Tienen orden.
# Se accede a elementos por su indice.
lista = ["Abel Tomas", "Dalto", True, 1.73]
...
# Tienen orden.
# Se accede a elementos por su indice.
tupla = ("Abel Tomas", "Dalto", True, 1.73)
...
# No se accede a los elementos por su indice.
# No tienen orden.
conjunto = {"Abel Tomas", "Dalto", True, 1.73}
...
# Muestra los datos por clave asociada, NO por indice.
diccionario = {
    "nombre": "Abel Tomas",
    "curso": "Dalto",
...
# ÏNDICE (Listas, Tuplas y cadenas)
...
# Si queremos obtener el ultimo dato y no sabemos su índice, empezamos con "-1", con esto tomará el ultimo dato.
...
# Permite acceder a un rango específico de elementos dentro de la secuencia, lo que resulta muy útil para manipular datos de manera eficiente.
