...
# and (&)
# Devuelve "True" si ambas expresiones son verdaderas y "False" en cualquier otro caso.
...
# or (|)
# Devuelve "False" si ambas condiciones no se cumplen y "True" en cualquier otro caso.
...
# not
# Devuelve el valor opuesto a la expresión dada.
